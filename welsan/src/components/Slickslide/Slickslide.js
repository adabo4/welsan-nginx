  ...
  return (
    <div className="carousel">
      ...
      <Slider ref={slider}  {...settings}>
        <div className="box">
          <h3><img src={require('../sliderimages/1.webp')} alt="Slider Image1"></img></h3>
        </div>
        <div className="box">
          <h3><img src={require('../sliderimages/2.webp')} alt="Slider Image2"></img></h3>
        </div>
        <div className="box">
          <h3><img src={require('../sliderimages/3.webp')} alt="Slider Image3"></img></h3>
        </div>
        <div className="box">
          <h3><img src={require('../sliderimages/4.webp')} alt="Slider Image4"></img></h3>
        </div>
      </Slider>
